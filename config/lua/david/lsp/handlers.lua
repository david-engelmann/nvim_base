...
vim.lsp.handlers["window/showMessage"] = require "david.lsp.show_message"
...
|| {
||   arguments = { "file://~/plugins/green_light.nvim/test/green_light/example_test.go", { "TestExample" }, vim.NIL },
||   command = "gopls.test",
||   title = "run test"
|| }
|| {
...
--   TestRun
--     :new({
--       file_pattern = "~/plugins/green_light.nvim/test/green_light/...",
