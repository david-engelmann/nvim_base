...
vim.cmd [[nnoremap ,ff :lua DE_GREP.grep_for_string(vim.fn.input("Grep For > "))<CR>]]
vim.cmd [[nnoremap ,fr :lua DE_GREP.replace_string(vim.fn.input("Grep For > "), vim.fn.input("Replace with > "))<CR>]]
